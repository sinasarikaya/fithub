...
export default class sıvıihtiyac extends Component {
...
*/
      ...
      sıvıhesap = () => {
        const sıvı = this.state.kg * (0.03);
        this.setState({
          resultNumber: sıvı.toFixed(1)
        });
    
        
          this.setState({ resultText: "Günlük Sıvı İhtiyacı" });
...
<Button onPress={this.sıvıhesap} iconLeft full title="Hesapla" color="#b3d9ff"/>
</View>


<Text style={styles.result}>{this.state.resultNumber+" "+"L"}</Text>
